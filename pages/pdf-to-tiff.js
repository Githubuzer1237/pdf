...
const PDFToTIFFPage = () => {
  ...
  const canonicalUrl = `https://pdfdok.com${locale === 'en' ? '' : '/' + locale}${PDFToTIFFTool.href}`; // Определяем канонический URL
  ...
  return (
    <>
      <Head>
        ...
        <title>Convert PDF to TIFF | PDF to TIFF Converter Online Free</title>
        <meta
          name="description"
          content="PDF to TIFF high-quality format with our online PDF to TIFF converter. Easily convert your PDF files into high-quality TIFF images with our PDF to TIFF conversion tool."
        />
        <meta
          name="Keywords"
          content="PDF to TIFF, PDF to TIFF converter, PDF to TIFF online, convert PDF to TIFF, online PDF to TIFF converter, PDF to TIFF free, TIFF from PDF, PDF to TIFF tool"
        />
        ...
        <link
  rel="alternate"
  href={`https://pdfdok.com/en${PDFToTIFFTool.href}`}
  hreflang="en"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/es${PDFToTIFFTool.href}`}
  hreflang="es"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ar${PDFToTIFFTool.href}`}
  hreflang="ar"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/zh${PDFToTIFFTool.href}`}
  hreflang="zh"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/de${PDFToTIFFTool.href}`}
  hreflang="de"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/fr${PDFToTIFFTool.href}`}
  hreflang="fr"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/it${PDFToTIFFTool.href}`}
  hreflang="it"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/pt${PDFToTIFFTool.href}`}
  hreflang="pt"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ru${PDFToTIFFTool.href}`}
  hreflang="ru"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/uk${PDFToTIFFTool.href}`}
  hreflang="uk"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/id${PDFToTIFFTool.href}`}
  hreflang="id"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/da${PDFToTIFFTool.href}`}
  hreflang="da"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/nl${PDFToTIFFTool.href}`}
  hreflang="nl"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/hi${PDFToTIFFTool.href}`}
  hreflang="hi"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ko${PDFToTIFFTool.href}`}
  hreflang="ko"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ja${PDFToTIFFTool.href}`}
  hreflang="ja"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com${PDFToTIFFTool.href}`}
  hreflang="x-default"
/>
      </Head>
        ...
        <section className="page_section">
          <article className={`container ${pageStyles.article_section}`}>
            ...
            <section className={pageStyles.article_content}>
              <p>{t("pdf-to-tiff:article_paragraph_01")}</p>
              <p>{t("pdf-to-tiff:article_paragraph_02")}</p>
              <p>{t("pdf-to-tiff:article_paragraph_03")}</p>
            </section>
          </article>
        </section>
        {/* Article End */}
