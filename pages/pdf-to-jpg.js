  ...
  return (
    <>
      <Head>
        ...
        <title>Convert PDF to JPG | Fast and Easy Online PDF to JPG Converter</title>
        <meta
          name="description"
          content="Easily convert your PDF files to high-quality JPG images with our fast and user-friendly online PDF to JPG converter. Preserve the original layout and quality of your documents while converting them to JPG format for easy sharing, printing, or storage."
        />
        <meta
          name="Keywords"
          content="PDF to JPG converter, PDF to JPG, online PDF to JPG converter, PDF to JPG conversion tool, free PDF to JPG converter, PDF to image converter."
        />
        {/* You can add your canonical link here */}
        <link rel="canonical"
          href={`https://pdfdok.com${PDFToJPGTool.href}`}
          key="canonical" />

        {/* You can add your alternate links here, example: */}
        <link
  rel="alternate"
  href={`https://pdfdok.com/en${PDFToJPGTool.href}`}
  hrefLang="en"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/es${PDFToJPGTool.href}`}
  hrefLang="es"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ar${PDFToJPGTool.href}`}
  hrefLang="ar"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/zh${PDFToJPGTool.href}`}
  hrefLang="zh"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/de${PDFToJPGTool.href}`}
  hrefLang="de"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/fr${PDFToJPGTool.href}`}
  hrefLang="fr"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/it${PDFToJPGTool.href}`}
  hrefLang="it"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/pt${PDFToJPGTool.href}`}
  hrefLang="pt"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ru${PDFToJPGTool.href}`}
  hrefLang="ru"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/uk${PDFToJPGTool.href}`}
  hrefLang="uk"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/id${PDFToJPGTool.href}`}
  hrefLang="id"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/da${PDFToJPGTool.href}`}
  hrefLang="da"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/nl${PDFToJPGTool.href}`}
  hrefLang="nl"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/hi${PDFToJPGTool.href}`}
  hrefLang="hi"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ko${PDFToJPGTool.href}`}
  hrefLang="ko"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ja${PDFToJPGTool.href}`}
  hrefLang="ja"
/>
      </Head>
        ...
        <section className="page_section">
          <article className={`container ${pageStyles.article_section}`}>
            ...
            <section className={pageStyles.article_content}>
              <p>{t("pdf-to-jpg:article_paragraph_01")}</p>
              <p>{t("pdf-to-jpg:article_paragraph_02")}</p>
              <p>{t("pdf-to-jpg:article_paragraph_03")}</p>
            </section>
          </article>
        </section>
        {/* Article End */}
