  ...
  return (
    <>
      <Head>
        ...
        <title>Convert PDF to BMP | PDF to BMP Converter Online Free</title>
        <meta
          name="description"
          content="Easily convert your PDF files to high-quality BMP images with our user-friendly online converter. Simply upload your PDF, select your preferred settings, and download your BMP files in seconds."
        />
        <meta
          name="Keywords"
          content="PDF to BMP, convert PDF to BMP, online PDF to BMP converter, free PDF to BMP converter, PDF to BMP converter"
        />
        {/* You can add your canonical link here */}
        <link rel="canonical"
          href={`https://pdfdok.com${PDFToBMPTool.href}`}
          key="canonical" />

        {/* You can add your alternate links here, example: */}
<link
  rel="alternate"
  href={`https://pdfdok.com/en${PDFToBMPTool.href}`}
  hreflang="en"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/es${PDFToBMPTool.href}`}
  hreflang="es"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ar${PDFToBMPTool.href}`}
  hreflang="ar"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/zh${PDFToBMPTool.href}`}
  hreflang="zh"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/de${PDFToBMPTool.href}`}
  hreflang="de"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/fr${PDFToBMPTool.href}`}
  hreflang="fr"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/it${PDFToBMPTool.href}`}
  hreflang="it"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/pt${PDFToBMPTool.href}`}
  hreflang="pt"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ru${PDFToBMPTool.href}`}
  hreflang="ru"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/uk${PDFToBMPTool.href}`}
  hreflang="uk"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/id${PDFToBMPTool.href}`}
  hreflang="id"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/da${PDFToBMPTool.href}`}
  hreflang="da"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/nl${PDFToBMPTool.href}`}
  hreflang="nl"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/hi${PDFToBMPTool.href}`}
  hreflang="hi"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ko${PDFToBMPTool.href}`}
  hreflang="ko"
/>
<link
  rel="alternate"
  href={`https://pdfdok.com/ja${PDFToBMPTool.href}`}
  hreflang="ja"
/>
<link
  rel="alternate"
        ...
        <section className="page_section">
          <article className={`container ${pageStyles.article_section}`}>
            ...
            <section className={pageStyles.article_content}>
              <p>{t("pdf-to-bmp:article_paragraph_01")}</p>
              <p>{t("pdf-to-bmp:article_paragraph_02")}</p>
              <p>{t("pdf-to-bmp:article_paragraph_03")}</p>
            </section>
          </article>
        </section>
        {/* Article End */}
